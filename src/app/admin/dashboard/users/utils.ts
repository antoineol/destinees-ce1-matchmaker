...
// Normalize search term (remove accents, trim, and lowercase)
...
// Normalize user fields (remove accents, trim, and lowercase)
export const normalizeUserFields = (user: User) => {
  return {
    id: user.id.toString(),
    firstName: normalizeSearchTerm(user.firstName),
    lastName: normalizeSearchTerm(user.lastName),
    dateOfBirth: normalizeSearchTerm(user.dateOfBirth),
    email: normalizeSearchTerm(user.email),
    password: normalizeSearchTerm(user.password),
  };
};
